...
def rag(company_name: str, policy_type: str):
    ...
    prompt = f"""
        Based on the following web data, provide a detailed report, in a professional tone, of the {policy_type} policies of the {company_name} company.
        ...
        Write your report in bullet points.
